...
"""
File: dashboard.+.py
This is argos configuration file
Should be kept under ~/.config/argos/ folder

This is for a gnome extension (https://github.com/p-e-w/argos)
This script uses APIs from another script which communicates with Home Assistant server and also facilitates with commandline operations.
"""
import base64
